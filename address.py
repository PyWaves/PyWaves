...
class Address(object):
    ...
    def cancelOrder(self, assetPair, order):
        ...
        req = pywaves.wrapper('/matcher/orderbook/%s/%s/cancel' % (DEFAULT_CURRENCY if assetPair.asset1.assetId=='' else assetPair.asset1.assetId, DEFAULT_CURRENCY if assetPair.asset2.assetId=='' else assetPair.asset2.assetId), data, host=pywaves.MATCHER)
        if pywaves.OFFLINE:
            return req
        else:
            id = -1
    ...
    def tradableBalance(self, assetPair):
        try:
            req = pywaves.wrapper('/matcher/orderbook/%s/%s/tradableBalance/%s' % (DEFAULT_CURRENCY if assetPair.asset1.assetId == '' else assetPair.asset1.assetId, DEFAULT_CURRENCY if assetPair.asset2.assetId == '' else assetPair.asset2.assetId, self.address), host=pywaves.MATCHER)
            if pywaves.OFFLINE:
                    return req
    ...
    def getOrderHistory(self, assetPair, timestamp=0):
        ...
        req = pywaves.wrapper('/matcher/orderbook/%s/%s/publicKey/%s' % (DEFAULT_CURRENCY if assetPair.asset1.assetId=='' else assetPair.asset1.assetId, DEFAULT_CURRENCY if assetPair.asset2.assetId=='' else assetPair.asset2.assetId, self.publicKey), headers=data, host=pywaves.MATCHER)
        return req
    ...
    def cancelOpenOrders(self, assetPair):
        ...
        for order in orders:
            ...
            if status=='Accepted' or status=='PartiallyFilled':
                ...
                pywaves.wrapper('/matcher/orderbook/%s/%s/cancel' % (DEFAULT_CURRENCY if assetPair.asset1.assetId == '' else assetPair.asset1.assetId, DEFAULT_CURRENCY if assetPair.asset2.assetId == '' else assetPair.asset2.assetId), data, host=pywaves.MATCHER)
    ...
    def deleteOrderHistory(self, assetPair):
        ...
        for order in orders:
            ...
            pywaves.wrapper('/matcher/orderbook/%s/%s/delete' % (DEFAULT_CURRENCY if assetPair.asset1.assetId == '' else assetPair.asset1.assetId, DEFAULT_CURRENCY if assetPair.asset2.assetId == '' else assetPair.asset2.assetId), data, host=pywaves.MATCHER)
